...
time_zone_gmt_offset = '+1:00:00'
new_ntp = '40.119.6.228'

admin_user_name = 'admin'
admin_old_password = 'PASSWORDCHANGE'
...
# 0 - sun, 1 - mon, ..., 6 - sat
start_dst_day_of_week = 0

# 1,2,3,4 - first, second, third or fourth, 5 - last
start_dst_day_order_number = 5
...
# End DST period
end_dst_month = 10
end_dst_day_of_week = 0
end_dst_day_order_number = 5
end_dst_hour = 2
# ==================================
...
def check_admin_password():
    ...
    check_user_password(admin_new_password, 'Wrong admin_new_password')
